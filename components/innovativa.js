...
XPCOMUtils.defineLazyGetter(this, "_", function()
  l10nHelper("chrome://prpl-innovativa/locale/innovativa.properties")
);
...
GTalkAccount.prototype = {
  ...
  connect: function() {
    ...
    if (!this._jid.node) {
      ...
      this._jid.domain = "innovativagroup.com";
...
GTalkProtocol.prototype = {
  ...
  get name() _("innovativaGroup.protocolName"),
  get normalizedName() "innovativa",
  get iconBaseURI() "chrome://prpl-innovativa/skin/",
  get usernameEmptyText() _("innovativaGroup.usernameHint"),
  ...
  classID: Components.ID("{6e3a5d40-afce-11e4-ab27-0800200c9a66}")
};
